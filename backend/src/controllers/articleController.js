...
import { summarizeWithApiFallback } from '../services/summarizationService.js';
...
export const getMostPopularArticles = async (req, res) => {
    try {
...
export const getMostSharedArticles = async (req, res) => {
    try {
        const articles = await getAllArticles();
...
export const fetchNow = async (req, res) => {
    try {
        ...
        const sources = await import('../config/sources');
